...
private:
    ...
    void inline compute_prepare();
    void inline compute_step(FAUSTFLOAT input0, FAUSTFLOAT input1, FAUSTFLOAT *output);

    bool left;
    
public:
    DspInner(bool left): left(left) {}
    ~DspInner() {}
};
...
private:
    ...
    FAUSTFLOAT fHslider0l,fHslider0r;
    FAUSTFLOAT fHslider1;
    FAUSTFLOAT fHslider2;
    FAUSTFLOAT fHslider3;
    FAUSTFLOAT fHslider4l,fHslider4r;
    FAUSTFLOAT fHslider5;
    FAUSTFLOAT fHslider6l,fHslider6r;
    FAUSTFLOAT fHslider7;
...
Dsp::Dsp()
	: PluginDef(), l(true), r(false) {
	version = PLUGINDEF_VERSION;
	flags = 0;
	id = "duckDelayDbl";
	name = N_("Duck Delay Dbl");
	groups = 0;
...
inline void DspInner::clear_state_f()
{
...
inline void DspInner::init(unsigned int samplingFreq)
{
...
{
    fHslider0l = FAUSTFLOAT(0.5); fHslider0r = FAUSTFLOAT(0.5);
    fHslider1 = FAUSTFLOAT(0.10000000000000001);
    fHslider2 = FAUSTFLOAT(0.10000000000000001);
    fHslider3 = FAUSTFLOAT(0.0);
    fHslider4l = FAUSTFLOAT(0.0); fHslider4r = FAUSTFLOAT(0.0);
    fHslider5 = FAUSTFLOAT(0.0);
    fHslider6l = FAUSTFLOAT(500.0); fHslider6r = FAUSTFLOAT(500.0);
...
void inline DspInner::compute_prepare()
{
    fSlow0 = std::pow(10.0, (0.050000000000000003 * double(fHslider0)));
    fSlow1 = std::exp((0.0 - (fConst3 / double(fHslider1))));
    fSlow2 = (1.0 - fSlow1);
    fSlow3 = std::exp((0.0 - (fConst3 / double(fHslider2))));
    fSlow4 = (1.0 - fSlow3);
    fSlow5 = (0.0010000000000000009 * std::pow(10.0, (0.050000000000000003 * double(fHslider3))));
    fSlow6 = double(fHslider4);
    fSlow7 = double(fHslider5);
    fSlow8 = (1.0 - fSlow7);
    fSlow9 = (fConst2 * double(fHslider6));
    fSlow10 = (1.0 - (fSlow7 * fSlow6));
    fSlow11 = double(fHslider7);
    fSlow12 = std::pow(10.0, (0.59999999999999998 * (1.0 - fSlow11)));
    fSlow13 = std::pow(10.0, (0.59999999999999998 * fSlow11));
}

void inline DspInner::compute_step(FAUSTFLOAT input0, FAUSTFLOAT input1, FAUSTFLOAT *output)
{
    ...
    if(left)
        *output = FAUSTFLOAT(((0.17782794100389229 * ((fRec0[0] * fRec3[0]) * ((fConst6 * ((((fConst8 * fRec4[0]) + (fConst17 * fRec4[1])) + (fConst8 * fRec4[2])) + (fSlow12 * (fRec12[2] + (fRec12[0] + (2.0 * fRec12[1])))))) + (fConst21 * ((fRec15[2] + (fRec15[0] + (2.0 * fRec15[1]))) + (fSlow13 * (((fConst28 * fRec18[0]) + (fConst32 * fRec18[1])) + (fConst28 * fRec18[2])))))))) + fTemp0));
    ...
    if(!left)
        *output = FAUSTFLOAT(((0.17782794100389229 * ((fRec3[0] * fRec21[0]) * ((fConst6 * ((((fConst8 * fRec24[0]) + (fConst17 * fRec24[1])) + (fConst8 * fRec24[2])) + (fSlow12 * (fRec27[2] + (fRec27[0] + (2.0 * fRec27[1])))))) + (fConst21 * ((fRec30[2] + (fRec30[0] + (2.0 * fRec30[1]))) + (fSlow13 * (((fConst28 * fRec33[0]) + (fConst32 * fRec33[1])) + (fConst28 * fRec33[2])))))))) + fTemp10));
    fRec2[1] = fRec2[0];
    fRec1[1] = fRec1[0];
    fRec0[1] = fRec0[0];
    fRec3[1] = fRec3[0];
...
{
    l.fHslider0 = fHslider0l;
    l.fHslider1 = fHslider1;
    l.fHslider2 = fHslider2;
    l.fHslider3 = fHslider3;
    l.fHslider4 = fHslider4l;
    l.fHslider5 = fHslider5;
    l.fHslider6 = fHslider6l;
    l.fHslider7 = fHslider7;
    l.compute_prepare();
    
    r.fHslider0 = fHslider0r;
    r.fHslider1 = fHslider1;
    r.fHslider2 = fHslider2;
    r.fHslider3 = fHslider3;
    r.fHslider4 = fHslider4r;
    r.fHslider5 = fHslider5;
    r.fHslider6 = fHslider6r;
    r.fHslider7 = fHslider7;
    r.compute_prepare();
    
    for (int i = 0; (i < count); i = (i + 1)) {
        l.compute_step(input0[i], 0/*input1[i]*/, output0+i);
        r.compute_step(0, input1[i], output1+i);
    }
}
...
{
	reg.registerVar("duckDelayDbl.amountl",N_("AmountL"),"S","",&fHslider0l, 0.5, 0.0, 56.0, 0.050000000000000003);
    reg.registerVar("duckDelayDbl.amountr",N_("AmountR"),"S","",&fHslider0r, 0.5, 0.0, 56.0, 0.050000000000000003);
	reg.registerVar("duckDelayDbl.attack",N_("Attack"),"S","",&fHslider1, 0.10000000000000001, 0.050000000000000003, 0.5, 0.050000000000000003);
	reg.registerVar("duckDelayDbl.coloration",N_("Coloration"),"S","",&fHslider7, 0.0, -1.0, 1.0, 0.050000000000000003);
	reg.registerVar("duckDelayDbl.effect",N_("Effect"),"S","",&fHslider3, 0.0, -16.0, 4.0, 0.10000000000000001);
	reg.registerVar("duckDelayDbl.feedbackl",N_("FeedbackL"),"S","",&fHslider4l, 0.0, 0.0, 1.0, 0.050000000000000003);
    reg.registerVar("duckDelayDbl.feedbackr",N_("FeedbackR"),"S","",&fHslider4r, 0.0, 0.0, 1.0, 0.050000000000000003);
	reg.registerVar("duckDelayDbl.pingpong",N_("Ping Pong"),"S","",&fHslider5, 0.0, 0.0, 1.0, 0.050000000000000003);
	reg.registerVar("duckDelayDbl.release",N_("Release"),"S","",&fHslider2, 0.10000000000000001, 0.050000000000000003, 2.0, 0.050000000000000003);
	reg.registerVar("duckDelayDbl.timel",N_("DelayL"),"S","",&fHslider6l, 10.0, 1.0, 2000.0, 1.0);
    reg.registerVar("duckDelayDbl.timer",N_("DelayR"),"S","",&fHslider6r, 10.0, 1.0, 2000.0, 1.0);
	return 0;
}
...
b.openHorizontalBox("");
{
	b.create_small_rackknob(PARAM("timel"),         _(" time l ms "));
    b.create_small_rackknob(PARAM("timer"),         _(" time r ms "));
	b.create_small_rackknob(PARAM("feedbackl"),     _(" feedback l "));
    b.create_small_rackknob(PARAM("feedbackr"),     _(" feedback r "));
...
b.openHorizontalBox("");
{
	...
	b.create_small_rackknob(PARAM("amountl"),        _(" amount l "));
    b.create_small_rackknob(PARAM("amountr"),        _(" amount r "));
